...
ExpressOAuthServer.prototype.authenticate = function (options) {
  ...
  return (req, res, next) => {
    ...
    return Promise.resolve()
      ...
      .catch(e => handleError.call(this, e, req, res, null, next))
  }
}
...
ExpressOAuthServer.prototype.authorize = function (options) {
  ...
  return (req, res, next) => {
    ...
    return Promise.resolve()
      .then(() =>  this.server.authorize(request, response, options))
      .then(code => {
      ...
      .catch(e => handleError.call(this, e, req, res, response, next))
  }
}
...
ExpressOAuthServer.prototype.token = function (options) {
  ...
  return (req, res, next) => {
    ...
    return Promise.resolve()
      .then(() => this.server.token(request, response, options))
      .then(token => {
        res.locals.oauth = { token: token }
        if (this.continueMiddleware) {
          next()
